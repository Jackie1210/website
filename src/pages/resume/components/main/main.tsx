    ...
    data: [
      {
        ...
        data: [
          ...
          '独立负责国际版播放器的重构及迭代工作，建立质量看板，保证上千QPS及百万DAU下核心播放页面的稳定性，推进与主站播放器团队的协作及后续架构。',
  ...
  return (
    <main className="resume-main">
      <Block title={'工作经历'}>
        ...
        {/* <Card {...{ company: 'Bilibili', job: '高级前端开发工程师', time: '2021.4~现在', url: 'https://www.bilibili.tv' }}>
          <p>Web站</p>
          <ul>
            <li>作为国际版Web站的核心开发之一，参与Web站从0-1的重构，基于vite+vue3+TS进行SSR开发。</li>
            <li>独立负责国际版播放器的重构及迭代工作，建立质量看板，保证上千QPS及百万DAU下核心播放页面的稳定性，推进与主站播放器团队的协作及后续架构。</li>
            <li>独立搭建国际版登录包，提升整体登录率；抽出登录SDK，赋能国际版其他业务线；建立看板监控登录成功率。</li>
            <li>基于pnpm+monorepo管理基础组件库+业务组件库，赋能国际版前端所有业务线。</li>
            <li>负责支付SDK、广告商业化的方案设计及实现。</li>
          </ul>
          <p>审核后台</p>
          <ul>
            <li>基于vue3+element-plus完成国际版审核后台从0到1的搭建工作，保证国际版业务的内容安全，为审核同学提效。</li>
          </ul>
        </Card> */}
        {/* <Card {...{ company: '携程', job: '高级前端开发工程师', time: '2019.6~2021.4', url: 'https://trip.com' }}>
          <ul>
            <li>独立负责智行铁友小程序火车票业务线的前端开发工作，保证需求的稳定迭代与维护。</li>
            <li>基于公司基建搭建内部接口，对小程序内部错误进行打点，方便错误追踪。</li>
            <li>基于vue2开发营销h5，助力业务增长。</li>
          </ul>
        </Card> */}
      </Block>
      <Block title={'教育经历'}>
